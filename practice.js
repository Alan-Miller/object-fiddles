...
favoriteThings.car = 'brown two-toned van';
favoriteThings.brand = 'M&Ms';


//Now change the food key in your favoriteThings object to be 'Lettuce' and change the book key in your favoriteThings object to be '50 Shades of Gray'.

favoriteThings.food = 'Lettuce';
favoriteThings.book = '50 Shades of Gray'; // Done under protest.
...
var alsoMe = {
  ...
  height: '5\'9\"-ish',
  gender: 'dude',
  married: 'let\'s not talk about it',
  eyeColor: 'blue',
  hairColor: 'brown'
};

for (var val in alsoMe) {
  //alert(alsoMe[val]);
}
